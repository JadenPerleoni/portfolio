    ...
    const skillList = [
        {
            id: 1,
            skill: 'Java',
            skillInfo: `Java was the first language that I've ever used beyond surface level
            programming. Using it has taught me many important programming concepts that I use 
            everyday. This is the language that I am most aquainted with.`
        },
        {
            id: 2,
            skill: 'Javascript',
            ...
            is useful in both front-end and back-end applications, making it a vital skill for any
            software developer.`
        },
        {
            id: 3,
